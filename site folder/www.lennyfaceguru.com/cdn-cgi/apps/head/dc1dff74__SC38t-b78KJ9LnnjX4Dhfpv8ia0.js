;window.CloudflareApps=window.CloudflareApps||{};CloudflareApps.siteId="8affa933c93995a37912f5adb144a717";CloudflareApps.installs=CloudflareApps.installs||{};;(function(){'use strict'
...
return false}}());CloudflareApps.installs["51sks2nQFo7c"]={appId:"lMxPPXVOqmoE",scope:{}};;CloudflareApps.installs["51sks2nQFo7c"].options={"anonymizeIp":false,"id":"UA-58088131-23","social":true};;if(CloudflareApps.matchPage(CloudflareApps.installs['51sks2nQFo7c'].URLPatterns)){(function(){var options=CloudflareApps.installs['51sks2nQFo7c'].options;var id;if(options.account&&options.organization){id=options["web-properties-for-"+options.organization];}else{id=(options.id||"").trim();}
if(!id){console.log("Cloudflare Google Analytics: Disabled. UA-ID not present.");return;}else if("51sks2nQFo7c"==="preview"){console.log("Cloudflare Google Analytics: Enabled",id);}
...
* File mirrored from https://www.lennyfaceguru.com/cdn-cgi/apps/head/SC38t-b78KJ9LnnjX4Dhfpv8ia0.js
* At UTC time: 2020-10-01 08:49:06.635646
*/
